...
TLfres = {}	-- namespace
local lg, lw, trans, scale, color, rect = love.graphics, love.window, love.graphics.translate, love.graphics.scale, love.graphics.setColor, love.graphics.rectangle
